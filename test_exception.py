...
class TestExceptionDemo(unittest.TestCase):
    ...
    def test_floating_point_error(self):
        self.assertRaisesWithMessage(
            FloatingPointError, ExceptionDemo.floating_point_error
        )
    ...
    def test_zero_division_error(self):
        self.assertRaisesWithMessage(
            ZeroDivisionError, ExceptionDemo.zero_division_error
        )
    ...
    def test_module_not_found_error(self):
        self.assertRaisesWithMessage(
            ModuleNotFoundError, ExceptionDemo.module_not_found_error
        )
    ...
    def test_unbound_local_error(self):
        self.assertRaisesWithMessage(
            UnboundLocalError, ExceptionDemo.unbound_local_error
        )
